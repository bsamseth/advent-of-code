...
using Data = int; // It appears this didn't need big integers. (if needed: boost::multiprecision::cpp_int);
...
enum Direction : unsigned {
    NORTH = 1, SOUTH = 2, WEST = 3, EAST = 4, NO_DIRECTION = 0
};
...
std::pair<bool, int>
find_oxygen_dfs(Process<Data>& droid, int steps_so_far = 0, Direction last_dir = Direction::NO_DIRECTION) {
