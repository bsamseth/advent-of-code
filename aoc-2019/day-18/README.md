...
Shortest path is `132` steps: `b`, `a`, `c`, `d`, `f`, `e`, `g`</li>
<li><pre><code>#################
#i.G..c...e..H.p#
########.########
#j.A..b...f..D.o#
...
Shortest paths are `136` steps;<br/>one is: `a`, `f`, `b`, `j`, `g`, `n`, `h`, `d`, `l`, `o`, `e`, `p`, `c`, `i`, `k`, `m`</li>
<li><pre><code>########################
#@..............ac.GI.b#
###d#e#f################
###A#B#C################
...
Shortest paths are `81` steps; one is: `a`, `c`, `f`, `i`, `d`, `g`, `b`, `e`, `h`</li>
