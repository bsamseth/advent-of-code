# Source: https://gist.github.com/tredfern0/796f5d9c415f8a429fdc4e3a2334257f
...
def bfs_move(inp, rowI, colI, hero, enemy):
    ...
    for move in first_moves:
        ...
        stack = [
            x
            for x in stack
            if inp[x[0]][x[1]] == "." and (x[0], x[1]) not in seen_coordinates
        ]
            ...
            for colI, col in enumerate(row):
                ...
                if isinstance(char, tuple):
                    ...
                    r, c = (
                        rowI,
                        colI,
                    )  # Keep track of our current coordinates in case we move
                    hero = char[0]
                    ...
                    if move_to:
                        r, c = (
                            move_to
                        )  # Need to update our current coordinates for the impending attack
